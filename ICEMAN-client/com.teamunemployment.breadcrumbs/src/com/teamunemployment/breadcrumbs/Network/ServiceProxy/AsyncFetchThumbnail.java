...
public class AsyncFetchThumbnail extends AsyncTask<String, Integer, Bitmap> {
    private String id;
    ...
    public AsyncFetchThumbnail(String id, RequestListener requestListener){
        this.id = id;
    ...
    protected Bitmap doInBackground(String... arg0) {
        URL url = null;
        try {
            url = new URL(LoadBalancer.RequestCurrentDataAddress() + "/images/"+id+"T.jpg");
