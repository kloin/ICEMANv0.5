...
/*
    ...
    private void setBackButtonListener() {
        ImageButton backButton = (ImageButton) findViewById(R.id.crumbs_back_button);
    ...
    private void setToolbarTitle(final CollapsingToolbarLayout toolbar, String trailId) {
