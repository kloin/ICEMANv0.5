    ...
    public void setUpClusterManager() {
        ...
        clusterManager.setOnClusterClickListener(new ClusterManager.OnClusterClickListener<DisplayCrumb>() {
            ...
            public boolean onClusterClick(Cluster<DisplayCrumb> displayCrumbCluster) {
                ...
                String mediaCount = "";
                if (photoCount > 1) {
                    mediaCount = mediaCount + photoCount + " photos";
                } else if (photoCount == 1) {
                    mediaCount = mediaCount + photoCount + " photo";
                }

                if (videoCount > 1) {
                    mediaCount = mediaCount + ", " + videoCount + " videos";
                } else if (videoCount == 1) {
                    mediaCount = mediaCount + ", " + videoCount + " video";
                }
                ...
                TextView mediaTextView = (TextView) context.findViewById(R.id.map_overlay_content_count);
