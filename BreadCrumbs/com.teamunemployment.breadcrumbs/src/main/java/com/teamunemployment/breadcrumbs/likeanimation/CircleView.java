package com.teamunemployment.breadcrumbs.likeanimation;
...
public class CircleView extends View {
    ...
    private void updateCircleColor() {
        float colorProgress = (float) com.teamunemployment.breadcrumbs.likeanimation.Utils.clamp(outerCircleRadiusProgress, 0.5, 1);
        colorProgress = (float) com.teamunemployment.breadcrumbs.likeanimation.Utils.mapValueFromRangeToRange(colorProgress, 0.5f, 1f, 0f, 1f);
