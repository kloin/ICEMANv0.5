...
/**
 * Written (stolen from google) by Josiah Kendall. Copyright 2015 all Rights Reserved.
 *
 * This class is used to regester a device with the Google Cloud Messenger service.
 */
public class RegistrationIntentService extends IntentService {
    ...
    private void sendRegistrationToServer(String token) {
        Log.d(TAG, "Registered with GCM. TOKEN = :" + token);
