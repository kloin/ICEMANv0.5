 ...
 */
public class BreadcrumbsExtractorSampleSource implements SampleSource, SampleSourceReader,
     ...
     */
    public BreadcrumbsExtractorSampleSource(Uri uri, DataSource dataSource, Allocator allocator,
    ...
    public void onLoadCompleted(Loadable loadable) {
        ...
        eventListener.onLoadCompleted(loadable);
    }
    ...
    private void maybeStartLoading() {
        ...
        try {
            ...
            // This is being thrown here by start loading, but only sometimes. However it really screws things up.
        }
    }
